...
public class Part1 {
    public static void main(String args[]) {
        ...
        filePath = filePath + "/app/resources/input.txt";
        ...
        try {
            ...
            Integer numVisibleTrees = forest.getVisibleTreeCount();
            System.out.print("Number of visible trees:\n");
            System.out.println(numVisibleTrees);
        } catch (IOException e) {
